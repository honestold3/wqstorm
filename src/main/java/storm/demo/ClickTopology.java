...
public class ClickTopology {
    ...
    public ClickTopology(){
        ...
        builder.setBolt("repeatsBolt", new storm.demo.RepeatVisitBolt(), 10)
        ...
        builder.setBolt("geoStats", new GeoStatsBolt(), 10).fieldsGrouping("geographyBolt", new Fields(storm.demo.Fields.COUNTRY));
